 ...
 * </p>
 * <p>
 * Description: Class for storing camera view configurations for display in a ViewportPanel.<br />
 * <br />
...
public class ViewportConfiguration
{
   ...
   /**
    * Adds a new camera view to this configuration. The new camera is placed in the specified row and
    * column and is the specified number of rows and columns in size.
    *
   ...
   /**
    * Retrieves a list of the stored ViewportPanelConfigurations. Each of these contain the relevant
    * information to display a camera view.
    *
