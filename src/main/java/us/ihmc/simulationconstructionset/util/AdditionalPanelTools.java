...
{
   /**
    * Adds a jpanel to the provided SCS instance that is available under Viewport -> Extra Panels. It
    * will show the reference frame that the selected YoVariable represents if that variable satisfies
    * the provided filter and the provided frame index map contains a frame mapping for the long value
    * of the variable. This also adds a label to the variable search box that will appear and show the
    * frame if the selected variable satisfies the filter.
    *
