...
public class SimulationRewindabilityVerifier
{
   ...
   public ArrayList<VariableDifference> checkRewindabilityWithSimpleMethod(int numTicksToTest, double maxDifferenceAllowed)
   ...
   public ArrayList<VariableDifference> checkRewindabilityWithSimpleMethod(int numTicksToStartComparingAt, int numTicksToTest, double maxDifferenceAllowed)
         throws UnreasonableAccelerationException
   {
      ArrayList<VariableDifference> variableDifferencesToReturn = new ArrayList<>();
   ...
   public ArrayList<VariableDifference> checkRewindabilityWithRigorousMethod(int numTicksToStartComparingAt, int numTicksToTest, int numTicksToSimulateAhead,
