...
public class StateFileComparer
{
    ...
    */
   public static ArrayList<VariableDifference> absoluteCompareStateFiles(String filenameOne, String filenameTwo, double maxAbsoluteDiff,
    ...
    */
   public static ArrayList<VariableDifference> percentualCompareStateFiles(String filenameOne, String filenameTwo, double maxPercentDiff,
                                                                           ArrayList<String> exceptions)
   {
      File fileOne = new File(filenameOne);
      File fileTwo = new File(filenameTwo);
   ...
   private static ArrayList<VariableDifference> compareStateFiles(File fileOne, File fileTwo, double maxDifference, boolean checkForPercentDifference,
   ...
   public static ArrayList<VariableDifference> compareVarLists(YoVariableList varListOne, YoVariableList varListTwo, double maxDifferenceAllowed,
                                                               boolean checkForPercentDifference, List<String> exceptions)
   {
