...
public class ShipCorridorGroundProfile implements GroundProfile3D, HeightMapWithNormals
{
   ...
   public ShipCorridorGroundProfile(double xMax, double xMin, double yMax, double yMin, double yMaxCorridor, double yMinCorridor, double zGroundPosition,
                                    double maxWallHeight)
   {
      ...
      wallInclination = Math.toRadians(2.0);//Default inclination of 2.0 degrees (roll)
   ...
   public ShipCorridorGroundProfile(double xMax, double xMin, double yMax, double yMin, double yMaxCorridor, double yMinCorridor, double zGroundPosition,
                                    double maxWallHeight, double wallInclination)
   {
      this.yMaxCorridor = yMaxCorridor;
      this.yMinCorridor = yMinCorridor;
      this.zGroundPosition = zGroundPosition;
   ...
   {
      /*
       * there are three areas (triangles): 1. left wall (positive y) 2. center 3. right wall (negative y)
       * For the closest intersection with the wall, first the y distance to the wall is computed. The y
       * and z values of this vector are then added to the y and z value of the point.
       */
