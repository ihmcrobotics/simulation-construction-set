...
public class RobotTest
{
   ...
   public void testSwitchingRootJoint()
         throws InterruptedException, UnreasonableAccelerationException, SimulationExceededMaximumTimeException, ControllerFailureException
   {
   ...
   public void testSingleFloatingBodyWithCoMOffset()
         throws SimulationExceededMaximumTimeException, InterruptedException, UnreasonableAccelerationException, ControllerFailureException
   {
   ...
   public void testFloatingJointAndPinJointWithMassiveBody() throws UnreasonableAccelerationException
   {
      ...
      floatingBody.setMomentOfInertia(getRotationalInertiaMatrixOfSolidEllipsoid(floatingBody.getMass(),
                                                                                 random.nextDouble(),
                                                                                 random.nextDouble(),
                                                                                 random.nextDouble()));
      root1.setLink(floatingBody);
   ...
   private static Link randomBody(Random random)
   {
      ...
      ret.setMomentOfInertia(getRotationalInertiaMatrixOfSolidEllipsoid(ret.getMass(), random.nextDouble(), random.nextDouble(), random.nextDouble()));
   ...
   public void testFreezeJointAtZeroTwo() throws UnreasonableAccelerationException
   {
      ...
      ArrayList<Joint> childrenJointsOne = new ArrayList<>();
      ...
      ArrayList<Joint> childrenJointsTwo = new ArrayList<>();
