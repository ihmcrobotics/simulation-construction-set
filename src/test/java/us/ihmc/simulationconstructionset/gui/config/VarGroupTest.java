...
public class VarGroupTest
{
   ...
   public void testSetAndGetName()
   {
      ...
      assertTrue("varGroupTestLongNameWithNumbers123456789" == varGroup.getName());
   }
   ...
   {
      String[] variablesToBeAdded = {variable1, variable2, variable3, variable4};
   ...
   {
      String[] regularExpressionsToBeAdded = {variable1, variable2, variable3, variable4};
      ...
      String[] regularExpressionsToBeAdded1 = {variable2, variable3, variable4};
