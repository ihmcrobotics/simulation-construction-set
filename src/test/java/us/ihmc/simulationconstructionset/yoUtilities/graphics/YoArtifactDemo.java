...
public class YoArtifactDemo
{
   public void showPlotter()
   {
      ...
      polygon2.set(FrameVertex2DSupplier.asFrameVertex2DSupplier(polyPoint1));
      ...
      polygon3.set(FrameVertex2DSupplier.asFrameVertex2DSupplier(polyPoint1, polyPoint2, polyPoint3));
